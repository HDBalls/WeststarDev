...
class SaleOrder(models.Model):
    ...
    approver_id = fields.Many2one('res.users', 'Sale Order Approver', readonly=True, copy=False, required=False, track_visibility='onchange', default=lambda self: self.env.user.employee_id.parent_id.user_id,
